...
Original file is located at
    https://colab.research.google.com/drive/1-HtpsbIaj7fbn_E_zLEeZvVBWmmHt1G1
"""
...
# If you also wanted to use a powerful Google model from Vertex AI as a fallback or alternative:
# from langchain_google_vertexai import VertexAI
# gemini_llm = VertexAI(model_name="gemini-pro-vision", project=PROJECT_ID, location=REGION)
...
# This chain will use the Vertex AI Vector Search retriever if it was successfully initialized.
qa_chain = RetrievalQA.from_chain_type(
    ...
    retriever=retriever, # This retriever exclusively uses data from the Vertex AI Vector Search (web-scraped content).
...
async def chat_endpoint(chat_request: ChatRequest):
    ...
    rag_response = None
    if retriever: # Only attempt RAG if retriever was successfully initialized
        try:
